...
def predict_note_file():
    df_test=pd.read_csv(request.files.get("x_test")) #or put file for 1 record prediction and to run in url # whatever name you written here the same name will provide in Post man
